...
|---|---|
| 항상 | `examine` |
| `disposition == "hostile"` | `attack` |
| `can_talk == true` | `talk` |
| `is_merchant == true` | `shop_open` |
| `disposition != "hostile"` | `attack` (우호 대상 공격 가능) |
...
├──────────────────────────────────────────────────────────────────────────────────┤
│  ── 적 ─────────────────────────────────────────────────────────────────         │
│   [⚔ Ash Raider]◀대상        HP ██████░░░░ 18/30    Lv.4                        │
│   [⚔ Ash Raider]             HP ██████████ 30/30    Lv.4                        │
│   [🐾 Small Rat]             HP ███░░░░░░░  4/12    Lv.1                        │
│  ── 우리 편 ────────────────────────────────────────────────────────────         │
